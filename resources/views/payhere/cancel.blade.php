...
<head>
    ...
    <style>
        ...
        body { font-family: 'Inter', sans-serif; background-color: #fef2f2; display: flex; justify-content: center; align-items: center; height: 100vh; margin: 0; }
        ...
        .btn { background-color: #dc2626; color: white; padding: 0.75rem 1.5rem; border-radius: 8px; text-decoration: none; font-weight: 600; }
...
<body>
    <div class="card">
        ...
        <a href="{{ route('payhere.test') }}" class="btn">Try Again</a>
    </div>
</body>
</html>
